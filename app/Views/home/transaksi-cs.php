                    ...
                    <div class="section-body">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4>Ringkasan Cleaning Service Yang Dipilih</h4>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                                    <li class="media">
                                        <img alt="image" class="mr-3" width="70" src="<?= base_url() ?>/assets/foto/cs_image.jpg">
                                        <div class="media-body">
                                            <div class="media-right">
                                                <div class="text-primary"><?= "Rp " . number_format($data['HARGA'], 2, ',', '.') ?></div>
                                            </div>
                                            <div class="media-title mb-1"><?= $data['NAMA_SERVICE'] ?></div>
                                            <div class="text-time"><?= 'Waktu : ' . $data['DURASI'] ?> jam</div>
                                            <?php
                    ...
                    <div class="section-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?= route_to('tr-cs-store-user'); ?>" class="needs-validation form-simpan" novalidate="">
                                    <?= csrf_field(); ?>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="tanggal">Tanggal Booking</label>
                                            <input type="hidden" name="ID_CLEANING_SERVICE" value="<?= $data['ID_CLEANING_SERVICE'] ?>">
                                            <input type="hidden" name="ID_USER" value="<?= session('ID_USER') ?>">
                                            <input type="hidden" name="TOTAL" id="total_" value="<?= $data['HARGA'] ?>">
                                            <input type="text" class="form-control  datepicker" id="tanggal" name="TANGGAL_BOOKING" placeholder="Pilih Tanggal Booking" required>
                                            <small>
                                                Usahakan tanggal booking harus diatas H+1 dari tanggal pemesanan
                                            </small>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="waktu">Tanggal Pengiriman Catering</label>
                                            <input type="text" class="form-control" id="waktu" name="WAKTU_BOOKING" placeholder="Masukkan Waktu Booking" value="08:00" required>
                                            <small>
                                                Waktu booking harus berupa jam dan menit dengan dipisahkan oleh tanda titik dua <b>:</b>
                                            </small>
                                        </div>
                                    </div>
