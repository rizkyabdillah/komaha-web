...
<div class="card">
    ...
    <div class="card-body">
        ...
        ?>
            ...
            ?>
                <p>Silahkan melakukan pembayaran dengan nominal diatas menggunakan metode <b>TRANSFER</b> menggunakan <b>BANK <?= $dataTR['BANK_PEMBAYARAN'] ?></b>, sebelum tanggal <b>(<?= date('Y-m-d', strtotime($dataTR['TANGGAL_PENGIRIMAN'] . '-1 day')) ?>)</b> dengan informasi pembayaran sebagai berikut :</p>
            <?php
            else :
            ?>
                <p><b>PEMBAYARAN ANDA DITOLAK!. </b><br>Silahkan melakukan pembayaran kembali dengan nominal diatas menggunakan metode <b>TRANSFER</b> menggunakan <b>BANK <?= $dataTR['BANK_PEMBAYARAN'] ?></b>, sebelum tanggal <b>(<?= date('Y-m-d', strtotime($dataTR['TANGGAL_PENGIRIMAN'] . '-1 day')) ?>)</b> dengan informasi pembayaran sebagai berikut :</p>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= route_to('tr-catering-update-bukti-user', $dataTR['ID_TRANSAKSI']); ?>" class="needs-validation form-simpan" novalidate="" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
