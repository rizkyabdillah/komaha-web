...
<h2 class="section-title">DETAIL TRANSAKSI CATERING</h2>
            ...
            <table class="table table-striped" id="sortable-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?= $dataCS['NAMA_SERVICE'] ?></td>
                        <td><?= "Rp " . number_format($dataCS['HARGA'], 2, ',', '.')?></td>
                        <td><?= $dataCS['DURASI'] ?> jam</td>
                        <td><?= "Rp " . number_format($dataTR['TOTAL'], 2, ',', '.')?></td>
                        <td><?= $dataTR['TANGGAL_BOOKING'] ?> - <?= $dataTR['WAKTU_BOOKING'] ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        ?>
            ...
            ?>
                <p>Silahkan melakukan pembayaran dengan nominal diatas menggunakan metode <b>TRANSFER</b> menggunakan <b>BANK <?= $dataTR['BANK_PEMBAYARAN'] ?></b>, sebelum tanggal <b>(<?= date('Y-m-d', strtotime($dataTR['TANGGAL_BOOKING'] . '-1 day')) ?>)</b> dengan informasi pembayaran sebagai berikut :</p>
            <?php
            else :
            ?>
                <p><b>PEMBAYARAN ANDA DITOLAK!. </b><br>Silahkan melakukan pembayaran kembali dengan nominal diatas menggunakan metode <b>TRANSFER</b> menggunakan <b>BANK <?= $dataTR['BANK_PEMBAYARAN'] ?></b>, sebelum tanggal <b>(<?= date('Y-m-d', strtotime($dataTR['TANGGAL_BOOKING'] . '-1 day')) ?>)</b> dengan informasi pembayaran sebagai berikut :</p>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= route_to('tr-cs-update-bukti-user', $dataTR['ID_TRANSAKSI']); ?>" class="needs-validation form-simpan" novalidate="" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
