...
<head>
    ...
    <title>KOMAHA - DAFTAR CLEANING SERVICE</title>
                        ...
                        ?>
                            <div class="col-xl-4 col-md-6 portfolio-item">
                                <div class="portfolio-wrap">
                                    <a href="<?= base_url(); ?>/assets/foto/cs_image.jpg" data-gallery="portfolio-gallery-app" class="glightbox"><img src="<?= base_url(); ?>/assets/foto/cs_image.jpg" class="img-fluid" alt=""></a>
                                    <div class="portfolio-info">
                                        <h4><a href="<?= route_to('detail-cs', $val['ID_CLEANING_SERVICE']) ?>" title="More Details"><?= $val['NAMA_SERVICE'] ?></a></h4>
                                        <p>
                                            <i class="bi bi-geo-alt flex-shrink-0"></i>&nbsp; <?= $ARR_FASILITAS[0] ?><br>
                                            <i class="bi bi-coin flex-shrink-0"></i><span>&nbsp; <?= "Rp " . number_format($val['HARGA'], 2, ',', '.') ?> / <?= $val['DURASI'] ?> jam</span>
                                        </p>
                                    </div>
                                </div>
