  ...
  DateRangePicker.prototype = {
    ...
    renderCalendar: function (side) {
      ...
      for (
        ...
        if (
          this.minDate &&
          calendar[row][col].format("DD/MM/YYYY") ==
    ...
    calculateChosenLabel: function () {
      ...
      for (var range in this.ranges) {
        if (this.timePicker) {
          ...
          if (
            this.startDate.format("DD/MM/YYYY") ==
              this.ranges[range][0].format("DD/MM/YYYY") &&
            this.endDate.format("DD/MM/YYYY") ==
              this.ranges[range][1].format("DD/MM/YYYY")
          ) {
            customRange = false;
            this.chosenLabel = this.container
              .find(".ranges li:eq(" + i + ")")
    ...
    timeChanged: function (e) {
      ...
      if (isLeft) {
        ...
        if (this.singleDatePicker) {
          ...
          this.endDate &&
          this.endDate.format("DD/MM/YYYY") == start.format("DD/MM/YYYY") &&
